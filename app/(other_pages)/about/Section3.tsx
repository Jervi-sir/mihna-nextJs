          ...
          <div className="row justify-center text-center">
            <div className="col-auto">
              ...
              <div className="sectionTitle ">
                ...
                <h2 className="sectionTitle__title text-white">Start your Learning Journey Today!</h2>
          ...
          <div className="row y-gap-30 justify-between pt-60 lg:pt-50">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="coursesCard -type-2 text-center pt-50 pb-40 px-30 rounded-8 bg-white shadow-2">
                <div className="coursesCard__image" style={{display: 'flex', justifyContent: 'center'}}>
                  <img src="img/home-5/learning/1.svg" alt="image" />
                </div>
                <div className="coursesCard__content mt-30">
                  <h5 className="coursesCard__title text-18 lh-1 fw-500">Learn with Experts</h5>
                  <p className="coursesCard__text text-14 mt-10">Grursus mal suada faci lisis that ipsum ameti consecte.</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="coursesCard -type-2 text-center pt-50 pb-40 px-30 rounded-8 bg-white shadow-2">
                ...
                <div className="coursesCard__content mt-30">
                  <h5 className="coursesCard__title text-18 lh-1 fw-500">Learn Anything</h5>
                  <p className="coursesCard__text text-14 mt-10">Grursus mal suada faci lisis that ipsum ameti consecte.</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="coursesCard -type-2 text-center pt-50 pb-40 px-30 rounded-8 bg-white shadow-2">
                ...
                <div className="coursesCard__content mt-30">
                  <h5 className="coursesCard__title text-18 lh-1 fw-500">Flexible Learning</h5>
                  <p className="coursesCard__text text-14 mt-10">Grursus mal suada faci lisis that ipsum ameti consecte.</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="coursesCard -type-2 text-center pt-50 pb-40 px-30 rounded-8 bg-white shadow-2">
                ...
                <div className="coursesCard__content mt-30">
                  <h5 className="coursesCard__title text-18 lh-1 fw-500">Industrial Standart</h5>
                  <p className="coursesCard__text text-14 mt-10">Grursus mal suada faci lisis that ipsum ameti consecte.</p>
                </div>
              </div>
            </div>
