...
export default function TermsConditions() {
  return (
    <>
      <section className="page-header -type-1 mt-60">
        ...
        <div data-anim-wrap className="container">
          <div className="row justify-center">
            ...
            <div className="col-xl-8 col-lg-9 col-md-11">
              <div className="mt-60 lg:mt-40">
                <h5>Pay Attention</h5>
                <p className="mt-30">Our Services are very diverse, so sometimes additional terms or product requirements (including age requirements) may apply. Additional terms will be available with the relevant Services, and those additional terms become part of your agreement with us if you use.</p>
              </div>
            </div>
          </div>
        </div>
